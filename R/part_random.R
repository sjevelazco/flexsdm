...
#'   \item loocv: Leave-one-out cross-validation (a.k.a. Jackknife). It is an spetial k-fold cross validation case where the number of partitions is equal to the number of records. Usage method = c(method = "loocv").
