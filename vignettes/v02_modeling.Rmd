...
(I THINK YOU WANT TO RUN NAMES HERE)
names(MAX_T1)
...
(I DO NOT THINK THE EXAMPLE SHOWN IS MAXENT. THIS IS A GLMNET)
(ALSO YOU SHOULD PUT HTE DESCRIPTION OF EACH MODEL OBJECT ELEMENT BEFORE THE EXAMPLE NOT AFTER)
...
max_t1$data_ens
```
Predicted suitability and test partition for each observation (row). 
...
(DO WE NEED TO SAY SOMETHING ABOUT THE NUMBER OF PARTITIONS CAN BE DIFFERENT THAN WHAT WAS USED FOR MODEL TUNING ABOVE?)
