...
plot(terra::crop(as(ca, 'Spatial'), layer1), add=TRUE) #ERROR ca object doesn't exist
...
plot(layer1, col="gray80", legend=FALSE, axes=FALSE)
plot(ca, add=TRUE)
points(hespero[,c("x", "y")], col = "black")
```
...
plot(layer1, col="gray80", legend=FALSE, axes=FALSE)
points(psa[,c("x", "y")], cex=0.8, pch=21) # Pseudo-absences
