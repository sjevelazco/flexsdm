...
points(abies_p[,c("x", "y")], col = alpha("#000004", 0.5))
```
...
plot(crop(as(ca, 'Spatial'), layer1), add=TRUE)
points(abies_p[,c("x", "y")], col = alpha("#000004", 0.5))
points(abies_pf[,c("x", "y")], col = alpha("#5DC861", 0.5))
```
...
plot(block_layer2, col=cl, legend=FALSE, axes=FALSE)
...
plot(block_layer2, col="gray80", legend=FALSE, axes=FALSE)
