...
- pchull:
  ...
  logical. Plot convex-hull limit of training data. Default FALSE. If
  TRUE it is necessary provide data in training_data argument
...
[`data_psp`](https://sjevelazco.github.io/flexsdm/reference/data_psp.md),
