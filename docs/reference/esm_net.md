...
This function constructs Neural Networks using the Ensembles of Small
Models (ESM) approach (Breiner et al., 2015, 2018).

## Usage

``` r
esm_net(data, response, predictors, partition, thr = NULL, size = 2, decay = 0)
```
...
- decay:
  ...
  numeric. Parameter for weight decay. Default 0.

## Value

A list object with:

- esm_model: A list with "nnet" class object from nnet package for each
...
detail see Breiner et al. (2015, 2018).
